<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = mysqli_query($conn,"INSERT INTO tblstudent(firstname,lastname,mobilenumber,email,address,creationdate)VALUES('$fname','$lname','$mobilenumber','$email','$address',NOW())");
